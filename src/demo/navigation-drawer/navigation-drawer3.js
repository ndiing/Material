...
class DemoNavigationDrawer3Component extends MdComponent {
    render() {
        return html`
            <div class="md-border">
...
customElements.define("demo-navigation-drawer3", DemoNavigationDrawer3Component);

export default document.createElement("demo-navigation-drawer3", DemoNavigationDrawer3Component);
