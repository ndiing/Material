                ...
                <div class="md-layout__grid">
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        <md-tooltip
                            ...
                            @onTooltipButtonClick="${() => tooltip1.toggle({ trigger: button1 })}"
                        ...
                        <md-button
                            ...
                            @click="${() => tooltip1.toggle({ trigger: button1 })}"
                        ></md-button>
                    </div>
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        <md-tooltip
                            ...
                            @onTooltipButtonClick="${() => tooltip2.toggle({ trigger: button2 })}"
                            >Rich tooltips bring attention to particular element of feature that warrants the user's focus.</md-tooltip
                        >
                        <md-button
                            id="button2"
                            ...
                            @click="${() => tooltip2.toggle({ trigger: button2 })}"
                        ></md-button>
                    </div>
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        <md-tooltip
                        ...
                        <md-button
                            ...
                            @click="${() => tooltip3.toggle({ trigger: button3 })}"
                        ></md-button>
                    </div>
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        <md-tooltip
                            ...
                            id="tooltip4"
                            .buttons="${[{ label: "Action" }]}"
                            @onTooltipButtonClick="${() => tooltip4.toggle({ trigger: button4 })}"
                            >Rich tooltips bring attention to particular element of feature that warrants the user's focus.</md-tooltip
                        >
                        <md-button
                            id="button4"
                            ...
                            @click="${() => tooltip4.toggle({ trigger: button4 })}"
                        ></md-button>
                    </div>
                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">
                        <md-tooltip
                            ...
                            id="tooltip5"
                            .buttons="${[{ label: "Action" }, { label: "Action" }]}"
                            @onTooltipButtonClick="${() => tooltip5.toggle({ trigger: button5 })}"
                            >Rich tooltips bring attention to particular element of feature that warrants the user's focus.</md-tooltip
                        >
                        <md-button
                            id="button5"
                            ...
                            @click="${() => tooltip5.toggle({ trigger: button5 })}"
                        ></md-button>
                    </div>
                </div>
            </div>
