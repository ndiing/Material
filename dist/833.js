                    ...
                    (c = [
                        {
                            ...
                            value: function () {
                                return (0, r.qy)(
                                    o || ((e = ['\n            <div class="md-layout">\n                <div class="md-layout__grid">\n                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">\n                        <md-menu\n                            id="menu1"\n                            .items="', '"\n                        ></md-menu>\n                        <md-button id="button1" variant="filled-tonal" label="Toggle Menu" @click="', '"></md-button>\n                    </div>\n                    <div class="md-layout__column--expanded12 md-layout__column--medium4 md-layout__column--compact4">\n                        <md-menu\n                            id="menu2"\n                            .items="', '"\n                        ></md-menu>\n                        <md-button id="button2" variant="filled-tonal" label="Toggle Menu" @click="', '"></md-button>\n                    </div>\n                </div>\n            </div>\n        ']), t || (t = e.slice(0)), (o = Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })))),
                                    [
